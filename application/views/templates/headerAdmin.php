...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/jpg" sizes="16x16" href="<?php echo base_url('assets/img/rere.jpg')?>">
    <!-- Custom CSS -->
...
<body>
    ...
    <img src="<?php  if (!empty($userData->profile_pic)) echo base_url('images/' . ($userData->profile_pic ?? '')); else  echo base_url('assets/img/icons8-user-48.jpg'); ?>" alt="Profile Picture" width="36" class="img-circle">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="text-center p-20 upgrade-btn">
                    <a href="<?php echo base_url('pages/db_authSubmission') ?>" class="btn btn-primary text-white" target="_blank" style="font-weight: bold;"><strong>MAKE A SUBMISSION</strong></a>
                </li>
            </ul>
        </nav>
