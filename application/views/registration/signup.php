...
<body>
    ...
    <!-- Page Header-->
    <header class="masthead" style="background-image: url('<?= base_url('assets/img/ayus.jpg'); ?>')">           
...
<!-- Sign-up Form -->
<div class="card">
    <div class="card-header bg-dark-white text-dark text-center fw-bold">Sign Up</div>
    <div class="card-body">
        <form action="<?php echo base_url('registration/registerNow')?>" method="POST" enctype="multipart/form-data">

            <div class="mb-3">
                <label for="profile-pic" class="form-label">Upload User Image</label>
